...
json.total_carbonation "#{((batch.batch_processes.category('carbonation').map {|batch_process| batch_process.stopped - batch_process.started }.sum)/60/60).round(1)} hrs"
json.total_bottling "#{((batch.batch_processes.category('bottling').map {|batch_process| batch_process.stopped - batch_process.started }.sum)/60/60).round(1)} hrs"