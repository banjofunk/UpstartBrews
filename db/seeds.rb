...
circulation = ProcessType.create(:name => 'circulation', :sort_order => 0)
ventilation = ProcessType.create(:name => 'ventilation', :sort_order => 1)
aeration = ProcessType.create(:name => 'aeration', :sort_order => 2, :secure => true)
refrigeration = ProcessType.create(:name => 'refrigeration', :sort_order => 3)
