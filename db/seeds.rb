...
circulation = ProcessType.create(:name => 'circulation')
ventilation = ProcessType.create(:name => 'ventilation')
aeration = ProcessType.create(:name => 'aeration')
...
finished_batch = Batch.create(:flavor_id => rose.id, :fermenter_id => ferm_4.id, :state => 1, :brew_date => (Time.current-21.days))
